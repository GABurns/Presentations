...
-   Create simulated Virtual Populations using KerusCloud with [recruitment sites]{.highlight} in 4 different countries, [baseline patient data]{.highlight} and [repeated measure]{.highlight} & [time to event]{.highlight} variables of disease occurrence
...
-   Continuous and Discrete[ ----------]{style="color:white;"}
-   Time to event [----------]{style="color:white;"}
-   Irreversible events[----------]{style="color:white;"}
-   Repeated Measures [----------]{style="color:white;"}
    \
...
-   Missingness [----------]{style="color:white;"}
-   Trunction[--------------]{style="color:white;"}
...
![](https://github.com/Exploristics/ExploristicsTheme/blob/main/man/figures/hex-ExploristicsTheme.png?raw=true){.absolute top=150 right=50 width="400px"}
:::
:::

::: {.fragment fragment-index=2}
![](https://github.com/dreamRs/esquisse/blob/master/man/figures/logo.png?raw=true){.absolute top=150 right=50 width="400px"}
:::
:::
:::
...
-   Data Storytelling [-----------------------------]{style="color:white;"}
