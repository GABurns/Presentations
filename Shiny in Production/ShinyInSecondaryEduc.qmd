...
<body>
    <div class="profile-card">
        ...
        <div class="profile-content">
            ...
            <div class="social">
                <a href="https://github.com/GABurns"><i class="fa fa-github" target="_blank"></i></a>
                <a href="https://x.com/GarethBurns4"><i class="fa fa-twitter" target="_blank"></i></a>
                <a href="https://www.linkedin.com/in/drgarethburns/" target="_blank"><i class="fa fa-linkedin"></i></a>
            </div>
        </div>
    </div>
    <!-- Font Awesome Icons -->
...
::: fragment
✏️ Develop [KerusCloud](https://exploristics.com/keruscloud-platform-overview/): a cloud-based clinical-trial simulation SaaS application
:::
...
<body>
    <div class="profile-card">
        ...
        <div class="profile-content">
            ...
            <div class="social">
                <a href="https://www.linkedin.com/in/steve-mallett-a1650712/" target="_blank"><i class="fa fa-linkedin"></i></a>
            </div>
        </div>
    </div>
    <!-- Font Awesome Icons -->
...
<body>
    <div class="profile-card">
        ...
        <div class="profile-content">
            ...
            <div class="social">
                <a href="https://github.com/statneutrino"><i class="fa fa-github" target="_blank"></i></a>
                <a href="https://www.linkedin.com/in/alex-spiers/"><i class="fa fa-linkedin" target="_blank"></i></a>
            </div>
        </div>
    </div>
    <!-- Font Awesome Icons -->
...
<body>
    <div class="profile-card">
        ...
        <div class="profile-content">
            ...
            <div class="social">
                <a href="https://www.linkedin.com/in/katie-gwinnell-aa90751b1/" target="_blank"><i class="fa fa-linkedin"></i></a>
            </div>
        </div>
    </div>
    <!-- Font Awesome Icons -->
...
<body>
    <div class="profile-card">
        ...
        <div class="profile-content">
            ...
            <div class="social">
                <a href="https://www.linkedin.com/in/emmaleecrawford/" target="_blank"><i class="fa fa-linkedin"></i></a>
            </div>
        </div>
    </div>
    <!-- Font Awesome Icons -->
...
<body>
    <div class="profile-card">
        ...
        <div class="profile-content">
            ...
            <div class="social">
                <a href="https://www.linkedin.com/in/my-luong-v-3a7161a3/"target="_blank"><i class="fa fa-linkedin"></i></a>
            </div>
        </div>
    </div>
    <!-- Font Awesome Icons -->
...
::: {data-id="scope" auto-animate-delay="0" style="background: #FFFFFF;  width: 900px; height: 500px; text-align: center; background-size: cover;  background-position: center; margin: auto; display: block; background-image:url('https://github.com/GABurns/Presentations/blob/master/Shiny%20in%20Production/img/ApplicationState.jpg?raw=true');"}
[The application is broke 2 hours before I've to use it with students]{.white-text}
:::

# Rewind {.section-title background-image="Slides/section3.PNG" background-size="contain"}
...
[^1]: National Curriculum https://www.gov.uk/government/publications/national-curriculum-in-england-mathematics-programmes-of-study/national-curriculum-in-england-mathematics-programmes-of-study
...
-   [Demonstrate technological proficiency in work]{.highlight}
...
Say the colour of the ink word, not the word itself[^3]

[^3]: https://en.wikipedia.org/wiki/Stroop_effect accessed on 8th October 2024
...
::: {data-id="red2" auto-animate-delay="0" style="color: #FFA500; width: 600px; height: 150px; text-align: center;"}
RED
:::
...
::: {data-id="purple2" auto-animate-delay="0" style="color: #FF0000; width: 600px; height: 150px; text-align: center;"}
PURPLE
:::
...
# Execution {.section-title background-image="Slides/section1.PNG" background-size="contain"}
...
::: columns
::: {.column width="60%"}
![](video/Randomisation.mp4){.absolute width="600"} <!-- {{< video video/Randomisation.mp4 width="600">}} -->
:::
...
::: columns
::: {.column width="60%"}
![](video/Timer.mp4){.absolute width="600"} <!-- {{< video video/Timer.mp4 width="600">}} -->
:::
...
::: columns
::: {.column width="60%"}
![](video/Boxplot_Feedback.mp4){width="600"} <!-- {{< video video/Boxplot_Feedback.mp4 width="600">}} -->
:::
...
::: fragment
::: callout-warning
80% work includes: - [Application State]{.highlight} - Responsiveness - Edge Cases - Scalability - Accessibility etc..
:::
:::
:::
:::
...
This slide was an iframe of the application deployed locally. Check out the [Jumping Rivers YouTube channel](https://www.youtube.com/channel/UCQMSMvzGNuUwHq6W6zlZq_A) for a walk-through.
:::
...
## Project Feedback {background-image="Slides/main.PNG" background-size="contain"}

::: columns
::: column
1.  [Interactive Learning:]{.highlight}
2.  [Showcase:]{.highlight}
:::

::: column
3.  [Data Literacy:]{.highlight}
4.  [Fun & Engaging]{.highlight}
:::
:::
